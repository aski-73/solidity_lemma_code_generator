...
contract ChargeInvoiceManagement {
    ...
    event ChargeInvoiceCreated(uint id, uint bookingId, string invoiceAmount);
    ...
    function createInvoice(uint _id, uint _bookingId, string memory _invoiceAmount) external {
        ...
        emit ChargeInvoiceCreated(_id, _bookingId, _invoiceAmount);
    }
